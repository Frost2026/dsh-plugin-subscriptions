...
const en = {
	...
	modelDefaultsNoLevels: "{count} models advertise no reasoning levels and always follow the provider.",
	...
	modelDefaultsExpand: "Expand the default reasoning effort list",
	modelDefaultsCollapse: "Collapse the default reasoning effort list",
	modelDefaultsSummary: "{total} models · {configured} overridden",
	modelDefaultsSummaryNone: "{total} models · following the provider",
...
const zh = {
	...
	modelDefaultsExpand: "展开默认推理档列表",
	modelDefaultsCollapse: "收起默认推理档列表",
...
function SubscriptionsSection(props) {
	...
	(0, react.useEffect)(() => {
		if (PROVIDERS.some(({ id }) => statuses[id]?.loggedIn === true)) {
			if (PROVIDERS.some(({ id }) => modelDefaultsOpen[id] === true && statuses[id]?.loggedIn === true) && Object.keys(modelDefaults).length === 0 && modelDefaultsLoadError === void 0) loadModelDefaultsData();
								...
								children: [
									...
									open && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
										...
										view.shown.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											...
											children: view.shown.map((model) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
