...
function SubscriptionsSection(props) {
	...
	(0, react.useEffect)(() => {
		if (PROVIDERS.some(({ id }) => hasAccount(statuses[id]))) {
			if (PROVIDERS.some(({ id }) => modelDefaultsOpen[id] === true && hasAccount(statuses[id])) && Object.keys(modelDefaults).length === 0 && modelDefaultsLoadError === void 0) loadModelDefaultsData();
