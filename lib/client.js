...
function SubscriptionsSection(props) {
	...
	const loadModelDefaultsData = (0, react.useCallback)(async () => {
	...
	(0, react.useEffect)(() => {
		if (PROVIDERS.some(({ id }) => statuses[id]?.loggedIn === true)) {
			if (Object.keys(modelDefaults).length === 0 && modelDefaultsLoadError === void 0) loadModelDefaultsData();
	...
	const setModelDefault = (0, react.useCallback)(async (provider, model, effort) => {
		...
		try {
				...
				return {
					...
					[provider]: {
						...
						models: section.models.map((entry) => entry.id === model ? {
							...entry,
							...effort === void 0 ? {} : { configured: effort }
						} : entry)
					}
				};
			});
			...
			if (mountedRef.current) setModelDefaultsSaving((current) => current === key ? void 0 : current);
		}
	}, [rpc]);
			...
			PROVIDERS.map(({ id, name }) => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						status?.loggedIn === true && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								modelDefaultsLoadError !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									style: styles$4.errorLine,
									children: t("modelDefaultsLoadFailed", { message: modelDefaultsLoadError })
								}),
								modelDefaultsLoadError === void 0 && modelDefaults[id] === void 0 && modelDefaultsLoading === true && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									style: styles$4.statusLine,
									children: t("modelDefaultsLoading")
								}),
								(modelDefaults[id]?.models ?? []).map((model) => model.efforts.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										style: styles$4.statusLine,
										children: t("modelDefaultsNoLevels")
									})]
								}, model.id) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									style: styles$4.defaultEffortRow,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: styles$4.defaultEffortName,
										children: model.name
								...
								Object.entries(modelDefaultsSaveErrors).filter(([key]) => key.startsWith(`${id}/`)).map(([key, message]) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									style: styles$4.errorLine,
									children: t("modelDefaultsSaveFailed", { message })
								}, key))
							]
						}),
