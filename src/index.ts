...
const DEFAULT_MODELS: Record<ProviderId, ModelEntry[]> = {
  ...
  claude: [
    ...
    { id: 'claude-opus-4-8', name: 'Claude Opus 4.8', maxTokens: 128_000, contextWindow: 1_000_000 },
    { id: 'claude-opus-4-7', name: 'Claude Opus 4.7', maxTokens: 128_000, contextWindow: 1_000_000 },
    { id: 'claude-sonnet-4-6', name: 'Claude Sonnet 4.6', maxTokens: 128_000, contextWindow: 1_000_000 },
    { id: 'claude-opus-4-6', name: 'Claude Opus 4.6', maxTokens: 128_000, contextWindow: 1_000_000 },
    { id: 'claude-opus-4-5-20251101', name: 'Claude Opus 4.5', maxTokens: 64_000 },
    { id: 'claude-haiku-4-5-20251001', name: 'Claude Haiku 4.5', maxTokens: 64_000 },
    { id: 'claude-sonnet-4-5-20250929', name: 'Claude Sonnet 4.5', maxTokens: 64_000, contextWindow: 1_000_000 },
  ],
  grok: [
